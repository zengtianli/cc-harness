...
- 默认：`~/Dev/stations/docs/knowledge/session-retro-{YYYYMMDD}-{topic-slug}.md`
- `--stdout` → 不写盘
...
参考 `~/Dev/stations/docs/knowledge/session-retro-20260419-r7-mega.md` —— R7 本轮的 playbook，含「核心编排」「通用 Playbook」「本次漏了什么 skill」三节。
