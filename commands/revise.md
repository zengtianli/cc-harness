...
- 写入修订：`/Users/tianli/miniforge3/bin/python3 ~/Dev/doctools/scripts/document/docx_tools.py track-changes review <file> -o <output> -r <rules.json> -a <author>`
- 读取修订：`/Users/tianli/miniforge3/bin/python3 ~/Dev/doctools/scripts/document/docx_tools.py track-changes read <file>`
...
```bash
/Users/tianli/miniforge3/bin/python3 ~/Dev/doctools/scripts/document/docx_tools.py track-changes review \
  "<输入文件>" \
  -o "<输出文件>" \
  -r "<rules文件>" \
  -a "<作者名>"
