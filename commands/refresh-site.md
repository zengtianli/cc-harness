...
# 2. navbar SSOT → web-stack/packages/menu-ssot/src/generated.ts (单点 SSOT)
...
# 7. React mega-navbar → @tlz/menu-ssot 单点 SSOT
python3 ~/Dev/devtools/lib/tools/menus.py build-react-mega-navbar -w

# 8. (v2.1+ removed) shared-navbar.generated.ts 不再 mirror — website + ops-console import @tlz/menu-ssot

# 9. services.ts AUTO-GEN
python3 ~/Dev/devtools/lib/tools/menus.py build-services-ts -w

# 10. 静态站重生成 HTML (stack)
