...
- 写入修订：`python3 ~/Dev/doctools/scripts/document/docx_tools.py track-changes review <file> -o <output> -r <rules.json> -a <author>`
- 读取修订：`python3 ~/Dev/doctools/scripts/document/docx_tools.py track-changes read <file>`
