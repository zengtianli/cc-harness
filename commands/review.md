...
- 深度审阅：`/Users/tianli/miniforge3/bin/python3 ~/Dev/doctools/scripts/document/review_deep.py <file> --rules <rule-name>`
...
```
/Users/tianli/miniforge3/bin/python3 ~/Dev/doctools/scripts/document/docx_tools.py track-changes review "<输入文件>" -o "<输出文件>" -r "<rules文件>"
```
