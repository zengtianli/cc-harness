...
|---|---|---|
| cmds | ~/Dev/cmds | 📚 CC Docs · Claude Code 命令 & 技能说明书 |
| stack | ~/Dev/stack | 🗂 Stack · ~/Dev 项目架构地图 |
| journal | ~/Dev/journal | 📔 Journal · HANDOFF / 方案 / 复盘时间线 |
| cc-evolution | ~/Dev/cc-evolution | 🔄 Changelog · CC 自我进化变更日志 |
| ops-console | ~/Dev/ops-console | 📊 Dashboard · VPS 服务 · 任务 · Git 提交总览 |
