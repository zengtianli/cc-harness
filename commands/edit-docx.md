...
脚本路径: `~/Dev/tools/scripts/scripts/document/docx_heading_edit.py`

```
用法:
  python3 ~/Dev/tools/scripts/scripts/document/docx_heading_edit.py <docx> --list
  python3 ~/Dev/tools/scripts/scripts/document/docx_heading_edit.py <docx> '<json_ops>' [--dry-run] [-o output]
```
...
```bash
python3 ~/Dev/tools/scripts/scripts/document/docx_heading_edit.py "$DOCX" '$OPS_JSON' --dry-run
```
