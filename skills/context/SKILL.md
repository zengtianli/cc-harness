...
```bash
# 读取 Word
python ~/Dev/doctools/scripts/document/docx_tools.py <file>

# 读取 Excel
python ~/Dev/hydro-risk/read_xlsx.py <file>

# 一键格式化 Word
python ~/Dev/doctools/scripts/document/docx_text_formatter.py <file>

# 地理编码
python ~/Dev/hydro-geocode/src/geocode_by_address.py
```
